...
BigDays.sfdfT$TorPerHours <- scale(BigDays.sfdfT$TorPerHour)
```
...
```{r}
summary(lm(log(nT) ~  maxCAPE * maxBS_deep + maxBS_shallow + minCIN, data = BigDays.sfdfT))
summary(lm(log(as.numeric(HullArea)) ~  maxCAPE + maxBS_shallow + maxBS_deep  + minCIN, data = BigDays.sfdfT))
summary(lm(log(TorPerHour) ~  maxCAPE + maxBS_deep + Lat + Lon, data = BigDays.sfdfT))
```
